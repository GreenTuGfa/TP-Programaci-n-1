...
public class Juego extends InterfaceJuego
{
	...
	public void tick()
	{
		...
		if(caballero != null && monedasObtenidasPorCaballero < 20 & monedasPerdidas < 10){
	...
	//Hecho con chatGPT// Genera nnumeros aleatorios entre 0 y 800 (excluyendo los valores que corresponden al X de la isla superior)
